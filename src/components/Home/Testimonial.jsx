...
const Testimonial = () => {
  ...
  return (
    <>
      <div>
        <WaveyPattern waveColor="#000" backgroundColor="#fff" />
        ...
        <HeroHighlight>
          <div className="mb-2 text-center pt-10 md:pt-20">
            ...
            <p className="text-white max-w-4xl mx-auto leading-relaxed">
              We provide end-to-end solutions in Digital Marketing, Graphic
              Designing and Branding, and Development to help your business
              thrive in the digital landscape.
            </p>
          </div>
          <AnimatedTestimonials testimonials={testimonials} />
        </HeroHighlight>
        <WaveyPattern backgroundColor="#000" />
      </div>
    </>
  );
};
